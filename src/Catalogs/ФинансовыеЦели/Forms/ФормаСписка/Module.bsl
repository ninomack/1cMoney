////////////////////////////////////////////////////////////////////////////////
//Справочник.ФинансовыеЦели.ФормаСписка
...
Процедура ПриСозданииНаСервере(Отказ, СтандартнаяОбработка)
	...
	Если Параметры.Отбор.Свойство("Кошелек", Кошелек) Тогда
		Параметры.Отбор.Удалить("Кошелек");
	КонецЕсли;
	ОбщегоНазначенияКлиентСервер.УстановитьПараметрДинамическогоСписка(Список, "Кошелек", ?(ЗначениеЗаполнено(Кошелек), Кошелек, ""));
	Если ЗначениеЗаполнено(Кошелек) Тогда
		Элементы.ТекущиеНакопления.Заголовок = "В <%1>";
		Элементы.ТекущиеНакопления.Заголовок = СтрШаблон(Элементы.ТекущиеНакопления.Заголовок, Строка(Кошелек));
	КонецЕсли;
	
	// Установка условного оформления для форм списков:
	СуммыИВалюты = Новый Структура("ТекущиеНакопления, ВсегоИспользовано", 
			Новый Массив, Новый Массив, Новый Массив);
	СуммыИВалюты.ТекущиеНакопления.Добавить("ТекущиеНакопления");
	СуммыИВалюты.ТекущиеНакопления.Добавить("Валюта1");
	СуммыИВалюты.ВсегоИспользовано.Добавить("ВсегоИспользовано");
	СуммыИВалюты.ВсегоИспользовано.Добавить("Валюта2");
	РаботаСФормамиСправочников.УстановитьУсловноеОформлениеФормыСписка(ЭтотОбъект, "Список", Ложь, , СуммыИВалюты, Ложь);
...
Процедура ОбработкаОповещения(ИмяСобытия, Параметр, Источник)
	...
	Если ИмяСобытия = "Записан элемент справочника" И ТипЗнч(Параметр) = Тип("Структура") И Параметр.ИмяСправочника = "ФинансовыеЦели" Тогда
