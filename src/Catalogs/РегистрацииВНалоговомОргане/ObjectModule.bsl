...
Процедура ЗаполнитьКодРегиона() Экспорт
	...
	КодРегиона = ВыделенныйМодульБРО.КодРегионаПоКодуНалоговогоОргана(Код);
...
Процедура ПередЗаписью(Отказ)
	...
	// ДЕНЬГИ ИначеЕсли Метаданные.Справочники.Найти("ФизическиеЛица") <> Неопределено И ТипЗнч(Представитель) = Тип("СправочникСсылка.ФизическиеЛица") Тогда	
	// ДЕНЬГИ	УполномоченноеЛицоПредставителя = "";
	КонецЕсли;
