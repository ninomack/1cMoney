...
Процедура ПослеЗаписиНаСервере(ТекущийОбъект, ПараметрыЗаписи)
	...
	// ДЕНЬГИ
	ОбщегоНазначенияДеньги.ИзменитьРазрешениеОткрыватьВнешниеОтчетыИОбработки(РазрешеноОткрытиеВнешнихОтчетовИОбработок, ПользовательИБИмя);
	// Конец ДЕНЬГИ
...
Функция НачальноеОписаниеПользователяИБ()
	...
	// ДЕНЬГИ
	РазрешеноОткрытиеВнешнихОтчетовИОбработок = ОбщегоНазначенияДеньги.РазрешеноОткрытиеВнешнихОтчетовИОбработок(ПользовательИБИмя);
