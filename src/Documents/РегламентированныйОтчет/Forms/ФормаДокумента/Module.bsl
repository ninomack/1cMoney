...
Процедура ПриСозданииНаСервере(Отказ, СтандартнаяОбработка)
	...
	// ДЕНЬГИ ЭлектронныйДокументооборотСКонтролирующимиОрганами.ОтметитьКакПрочтенное(Объект.Ссылка);
		...
		Попытка
			...
			Если мСкопированаФорма = Неопределено Тогда
				...
				Иначе
					...
					Если Объект.ИспользоватьПомощникЗаполнения Тогда
						ВыбраннаяФорма = СтрЗаменить(ВыбраннаяФорма, "2014", "2011");
						ИмяФормыОтчета = ВариантФормыОтчета + Объект.ИсточникОтчета + ".Форма.ПомощникЗаполнения" + Прав(ВыбраннаяФорма, 7);
					Иначе
						ИмяФормыОтчета = ВариантФормыОтчета + Объект.ИсточникОтчета + ".Форма." + ВыбраннаяФорма;
					КонецЕсли; 
					// Конец ДЕНЬГИ
			...
			Иначе
				...
				Иначе
					...
					// ДЕНЬГИ
					//ИмяФормыОтчета = ВариантФормыОтчета + Объект.ИсточникОтчета + ".Форма." + мСкопированаФорма;
				...
				ФормаОтчета.Налогоплательщик = Объект.Организация;
				// Конец ДЕНЬГИ
