...
Процедура ПриСозданииНаСервере(Отказ, СтандартнаяОбработка)
	...
	// ДЕНЬГИ СдачаОтчетностиЧерезТакскомСпринтерКлиентСервер.ВидимостьКнопкиЗашифроватьИОтправить(ЭтаФорма);
			...
			Иначе
				...
				Попытка
					...
					Иначе // это декларация по алкоголю
						...
						Иначе
							КодАбонента = ""; // ДЕНЬГИ СдачаОтчетностиЧерезТакскомСпринтерВызовСервера.ПолучитьНастройкиИнтеграцииСоСпринтером(Объект.Организация).КодАбонента;
...
Процедура ЗашифроватьИОтправить(Команда)
	...
	// ДЕНЬГИ СдачаОтчетностиЧерезТакскомСпринтерКлиент.ПроверитьНастройкиИнтеграцииСоСпринтером(ЭтотОбъект, ОписаниеОповещения);
...
Процедура ЗашифроватьИОтправитьПослеПроверкиПослеСохраненияТекстов(Результат, ВходящийКонтекст) Экспорт
	...
	#Иначе
		...
		// ДЕНЬГИ СдачаОтчетностиЧерезТакскомСпринтерКлиент.ОтправитьВСпринтерСогласноНастройкамОрганизации(Объект.Организация);
