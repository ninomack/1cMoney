...
Процедура ДобавитьДополнительныеФайлы(ФормаОтчета, ДанныеДляЗагрузки)
	...
	ТипДокументаБухгалтерскаяОтчетность =  // ДЕНЬГИ
				Вычислить("ПредопределенноеЗначение(""Перечисление.ТипыОтправляемыхДокументов.БухгалтерскаяОтчетность"")");
	
	Если ДанныеДляЗагрузки.ТипДокумента = ТипДокументаБухгалтерскаяОтчетность Тогда
		
		ТипФайлаБухОтчетностиАудиторскоеЗаключение               =  // ДЕНЬГИ
					Вычислить("ПредопределенноеЗначение(""Перечисление.ТипыФайловБухОтчетности.АудиторскоеЗаключение"")");
		ТипФайлаБухОтчетностиЗаявлениеСоюзаСельхозПроизводителей =  // ДЕНЬГИ
					Вычислить("ПредопределенноеЗначение(""Перечисление.ТипыФайловБухОтчетности.ЗаявлениеСоюзаСельхозПроизводителей"")");
		ТипФайлаБухОтчетностиПояснительнаяЗаписка                =  // ДЕНЬГИ
					Вычислить("ПредопределенноеЗначение(""Перечисление.ТипыФайловБухОтчетности.ПояснительнаяЗаписка"")");
