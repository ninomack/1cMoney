...
Процедура ПередНачаломРаботыСистемы(Параметры) Экспорт
	...
	ДеньгиВызовСервера.ПроверитьНачальныеНастройкиИнтерфейса(Параметры.Отказ, , ОбновлятьИнтерфейс, ПараметрЗапуска);
...
Процедура ПриНачалеРаботыСистемы(Параметры) Экспорт
	...
	// ДЕНЬГИ
	ДеньгиВызовСервера.ПроверитьПределПланирования();
	// Конец ДЕНЬГИ
...
Процедура ПослеНачалаРаботыСистемы() Экспорт
	...
	ЕстьДоступКДанным = Не ПараметрыРаботыКлиента.РазделениеВключено 
			Или ПараметрыРаботыКлиента.ДоступноИспользованиеРазделенныхДанных;
	
	// Нужно ди начинать с помощника начала работы?
	Если ЕстьДоступКДанным
		И ПараметрыРаботыКлиента.Свойство("ОткрытьПомощникНачалаРаботы") И ПараметрыРаботыКлиента.ОткрытьПомощникНачалаРаботы Тогда
		
		ДеньгиВызовСервера.УстановитьИнтерфейсПриложенияПоФорме("Обработка.ПомощникНачалаРаботы.Форма", Истина);
		ОбновитьИнтерфейс();
		Возврат;
	...
	ИначеЕсли ПараметрыРаботыКлиента.РазделениеВключено Тогда
		
		ИмяФормы = "РегистрСведений.СообщенияОбменаДаннымиОбластейДанных.ФормаСписка";
