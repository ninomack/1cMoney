...
Процедура ПолучитьПланыОбмена(ПланыОбменаПодсистемы) Экспорт
	...
	// ДЕНЬГИ
	ПланыОбменаПодсистемы.Добавить(Метаданные.ПланыОбмена.МобильноеПриложение);
	Если ОбщегоНазначения.ПодсистемаСуществует("ФункционалКонфигурацииДеньги.ОбменСЦентральнойБазой") Тогда
		...
		Модуль.ПолучитьПланыОбмена(ПланыОбменаПодсистемы);
	КонецЕсли;
	// Конец ДЕНЬГИ
...
Процедура ПриВыгрузкеДанных(СтандартнаяОбработка,
	...
	// ДЕНЬГИ
	СинхронизацияАвтономныхКопий.ОбработчикПриВыгрузкеДанных(СтандартнаяОбработка,
								Получатель,
								ИмяФайлаСообщения,
								ДанныеСообщения,
								КоличествоЭлементовВТранзакции,
...
Процедура ПриЗагрузкеДанных(СтандартнаяОбработка,
	...
	// ДЕНЬГИ
	СинхронизацияАвтономныхКопий.ОбработчикПриЗагрузкеДанных(СтандартнаяОбработка,
								Отправитель,
								ИмяФайлаСообщения,
								ДанныеСообщения,
								КоличествоЭлементовВТранзакции,
...
Процедура ПриПолученииДоступныхВерсийФормата(ВерсииФормата) Экспорт
	...
	// ДЕНЬГИ
	ВерсииФормата.Вставить("2.0.0.0",    МенеджерСинхронизацииАвтономныхКопий_10);
	ВерсииФормата.Вставить("2.0",        МенеджерСинхронизацииАвтономныхКопий_10);
	// Конец Деньги
