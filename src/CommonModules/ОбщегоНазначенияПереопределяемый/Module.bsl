...
Процедура ПриОпределенииОбщихПараметровБазовойФункциональности(ОбщиеПараметры) Экспорт
	...
	// ДЕНЬГИ
	ОбщегоНазначенияДеньги.ПриОпределенииОбщихПараметровБазовойФункциональности(ОбщиеПараметры);
	// Конец ДЕНЬГИ 
...
Процедура ПриДобавленииОбработчиковУстановкиПараметровСеанса(Обработчики) Экспорт
	...
	// ДЕНЬГИ
	ОбщегоНазначенияДеньги.ПриДобавленииОбработчиковУстановкиПараметровСеанса(Обработчики);
	// Конец ДЕНЬГИ
...
Процедура ПриДобавленииПараметровРаботыКлиентаПриЗапуске(Параметры) Экспорт
	...
	// ДЕНЬГИ
	ОбщегоНазначенияДеньги.ПараметрыРаботыКлиентаПриЗапуске(Параметры);
	// Конец ДЕНЬГИ
...
Процедура ПриДобавленииИсключенийПоискаСсылок(ИсключенияПоискаСсылок) Экспорт
	...
	// ДЕНЬГИ
	ОбщегоНазначенияДеньги.ПриДобавленииИсключенийПоискаСсылок(ИсключенияПоискаСсылок);
	// Конец ДЕНЬГИ
...
Процедура ПриОпределенииПоддерживаемыхВерсийПрограммныхИнтерфейсов(ПоддерживаемыеВерсии) Экспорт
	...
	Версии = Новый Массив;
	Версии.Добавить("2.0"); 
	ПоддерживаемыеВерсии.Вставить("УниверсальныйФорматДенег", Версии);
	// Конец ДЕНЬГИ
