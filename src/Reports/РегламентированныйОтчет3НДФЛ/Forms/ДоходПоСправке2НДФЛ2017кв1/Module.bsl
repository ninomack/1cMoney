...
Процедура ПриСозданииНаСервере(Отказ, СтандартнаяОбработка)
	...
	ЗаполнитьЗначенияСвойств(ЭтотОбъект, КонтейнерДокумента.ШапкаДокумента, "ИсточникНаименование,ИсточникИНН,
				|ИсточникКПП,ИсточникОКАТО,НалоговаяБаза,ИндивидуальныйИнвестиционныйСчет");
...
Процедура Строки2НДФЛКодДоходаНачалоВыбора(Элемент, ДанныеВыбора, СтандартнаяОбработка)
	...
	ОткрытьФорму(СтрЗаменить(ЭтаФорма.ИмяФормы, "ДоходПоСправке2НДФЛ2017кв1", "ВыборКодаДоходаИВычета"), ПараметрыФормы, Элемент, Истина, , , Оповещение, РежимОткрытияОкнаФормы.БлокироватьОкноВладельца);
...
Процедура ЗаписатьДокументЗавершение()
	...
	Результат.ШапкаДокумента.Вставить("ИндивидуальныйИнвестиционныйСчет", ИндивидуальныйИнвестиционныйСчет);
