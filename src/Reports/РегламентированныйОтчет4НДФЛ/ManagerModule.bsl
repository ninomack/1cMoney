...
Функция ТаблицаФормОтчета() Экспорт
	...
	НоваяФорма.ОписаниеОтчета     = "Приложение №1 к приказу ФНС РФ от 27.12.2010 № ММВ-7-3/768@";
	// Конец ДЕНЬГИ
	...
	НоваяФорма.ОписаниеОтчета     = "Приложение №1 к приказу ФНС РФ от 27.12.2010 № ММВ-7-3/768@ (в редакции приказа ФНС РФ от 14.11.2013 № ММВ-7-3/501@)";
	// Конец ДЕНЬГИ
