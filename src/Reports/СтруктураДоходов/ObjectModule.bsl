...
Функция ПараметрыСобытийОтчета() Экспорт
	...
	//ПараметрыСобытийОтчета.ВыполнятьПередКомпоновкойРезультата = Ложь;
	//ПараметрыСобытийОтчета.ВыполнятьПослеКомпоновкиРезультата = Ложь;
...
Процедура ПриСозданииФормыНаСервере(ЭтаФорма, Отказ, СтандартнаяОбработка, СтандартнаяОбработкаВФорме) Экспорт
	...
	//КонецЕсли;
	//
	//Если Отбор.Свойство("СтатьяДохода") Тогда
	//	ЭлементОтбора = КомпоновщикНКД.Настройки.Отбор.Элементы.Добавить(Тип("ЭлементОтбораКомпоновкиДанных"));
	//	ЭлементОтбора.Использование = Истина;
	//	ЭлементОтбора.ЛевоеЗначение = Новый ПолеКомпоновкиДанных("СтатьяДохода");
	//	ЭлементОтбора.ВидСравнения = ВидСравненияКомпоновкиДанных.ВИерархии;
	//	ЭлементОтбора.ПравоеЗначение = Отбор.СтатьяДохода;
	//	Отбор.Удалить("СтатьяДохода");
	//КонецЕсли;
	//
	//// Заголовок отчета
...
Процедура ПриОбработкеПараметраФормыОтбор(Отбор, ЭтаФорма) Экспорт
	...
	Если Отбор.Свойство("СтатьяДохода") Тогда
		ЭлементыОтбора = ОбщегоНазначенияКлиентСервер.НайтиЭлементыИГруппыОтбора(КомпоновщикНастроек.ФиксированныеНастройки.Отбор, "СтатьяДохода");
