////////////////////////////////////////////////////////////////////////////////
//Отчет.РегламентированныйОтчет3НДФЛ.Форма.ВычетСоциальный
//  Указание социальных вычетов
//  
//Параметры формы:
...
Процедура ПриСозданииНаСервере(Отказ, СтандартнаяОбработка)
	...
	Элементы.ОбычноеЛечение.Видимость = Декларация3НДФЛВыбраннаяФорма = "ФормаОтчета2020кв1";
...
Функция РассчитатьСуммуВычета(Форма)
	...
	Возврат Форма.ОбучениеСвое + Форма.ОбучениеДетей
		+ Форма.ДорогостоящееЛечение + Форма.ОбычноеЛечение + Форма.ЛечениеМедикаменты + Форма.МедицинскоеСтрахование
...
Функция РезультатДляЗаписи()
	...
	Результат.Вставить("Представление", СтрШаблон("Вычет социальный"));
	Результат.Вставить("СтруктураДокумента", СтруктураДокумента);
	Результат.Вставить("СуммаДохода", 0);
	Результат.Вставить("СуммаВычета", РассчитатьСуммуВычета(ЭтотОбъект));
