...
Процедура ПриСозданииНаСервере(Отказ, СтандартнаяОбработка)
	...
	ИспользоватьВебСервисТолькоВРежимеВебКлиента           = ""; // ДЕНЬГИ Константы.ИспользоватьСервисФормированияМЧБсPDF417ТолькоВРежимеВебКлиента.Получить();
	АдресТочкиПодключенияВебСервиса                        = ""; // ДЕНЬГИ Константы.АдресСервисаФормированияМЧБсPDF417.Получить();
	ИмяПользователяВебСервиса                              = ""; // ДЕНЬГИ Константы.ИмяПользователяСервисаФормированияМЧБсPDF417.Получить();
	ПарольПользователяВебСервиса                           = ""; // ДЕНЬГИ Константы.ПарольПользователяСервисаФормированияМЧБсPDF417.Получить();
