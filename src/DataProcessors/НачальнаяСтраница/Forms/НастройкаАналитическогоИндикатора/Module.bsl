...
Процедура ПриСозданииНаСервере(Отказ, СтандартнаяОбработка)
	...
	ЗаполнитьСписокВидовИндикаторов();
	...
	Если ТипЗнч(Период) = Тип("Структура") И ЗначениеЗаполнено(Период) Тогда
...
&НаСервере
Процедура ЗаполнитьСписокВидовИндикаторов()
	
	Элементы.ТипИндикатора.СписокВыбора.Очистить();
	
	Если ОбщегоНазначения.ПодсистемаСуществует("ФункционалКонфигурацииДеньги.ОбменСЦентральнойБазой") Тогда
		Элементы.ТипИндикатора.СписокВыбора.Добавить("РежимРаботы", "Режим работы приложения");
	КонецЕсли;
	
	Элементы.ТипИндикатора.СписокВыбора.Добавить("ВводОпераций", "Ввод новых операций");
	Элементы.ТипИндикатора.СписокВыбора.Добавить("Структура", "Структура доходов или расходов");
	Элементы.ТипИндикатора.СписокВыбора.Добавить("Динамика", "Динамика доходов, расходов или доходов и расходов");
	Элементы.ТипИндикатора.СписокВыбора.Добавить("Планы", "Суммы плановых операций");
	Элементы.ТипИндикатора.СписокВыбора.Добавить("КурсыВалют", "Курсы валют");
	Элементы.ТипИндикатора.СписокВыбора.Добавить("Накопления", "Накопления на финансовые цели");
	Элементы.ТипИндикатора.СписокВыбора.Добавить("Бюджет", "Состояние бюджета");
